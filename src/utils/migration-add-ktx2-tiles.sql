-- Add KTX2 manifest URL column to scenes table
ALTER TABLE scenes
  ADD COLUMN IF NOT EXISTS tile_medium_ktx2_manifest_url TEXT;

-- Update get_tour_data RPC to include the new column
